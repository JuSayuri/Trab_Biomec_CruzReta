...
print("USUÁRIO ESCOLHA UMA DAS OPÇÕES")
print("1 - Calcular com os valores da planilha")
print("2 - Calcular com valores que eu desejo")
...
def print_menu():
    for key in menu_opções.keys():
        print (key, '--', menu_opções[key] )
option = int(input('Escolha uma opcao: '))
if option == 1:
    pass
elif option == 2:
    xc1 = []
    xc1.append(float(input("xc1 - Valor 1: ")))
    xc1.append(float(input("xc1 - Valor 2: ")))
    xc1.append(float(input("xc1 - Valor 3: ")))
    xy1 = []
    xy1.append(float(input("xy1 - Valor 1: ")))
    xy1.append(float(input("xy1 - Valor 2: ")))
    xy1.append(float(input("xy1 - Valor 3: ")))
    xp1 = []
    xp1.append(float(input("xp1 - Valor 1: ")))
    xp1.append(float(input("xp1 - Valor 2: ")))
    xp1.append(float(input("xp1 - Valor 3: ")))
    yp1 = []
    yp1.append(float(input("yp1 - Valor 1: ")))
    yp1.append(float(input("yp1 - Valor 2: ")))
    yp1.append(float(input("yp1 - Valor 3: ")))
    xc2 = []
    xc2.append(float(input("xc2 - Valor 1: ")))
    xc2.append(float(input("xc2 - Valor 2: ")))
    xc2.append(float(input("xc2 - Valor 3: ")))
    yc2 = []
    yc2.append(float(input("yc2 - Valor 1: ")))
    yc2.append(float(input("yc2 - Valor 2: ")))
    yc2.append(float(input("yc2 - Valor 3: ")))
    xp2 = []
    xp2.append(float(input("xp2 - Valor 1: ")))
    xp2.append(float(input("xp2 - Valor 2: ")))
    xp2.append(float(input("xp2 - Valor 3: ")))
    yp2 = []
    yp2.append(float(input("yp2 - Valor 1: ")))
    yp2.append(float(input("yp2 - Valor 2: ")))
    yp2.append(float(input("yp2 - Valor 3: ")))
